    ...
    with input_tabs[3]:
        ...
        if scenario_name in ("gas_cycling", "lean_gas_injection"):
            ...
            if scenario_name == "lean_gas_injection" or gas_cycling_injection_mode == "user_defined":
                ...
                with lc1:
                    lg_h2s = st.number_input("Injected gas H2S", min_value=0.0, max_value=1.0, value=0.0, step=0.001, format="%.4f")
                    lg_co2 = st.number_input("Injected gas CO2", min_value=0.0, max_value=1.0, value=0.02, step=0.001, format="%.4f")
                    lg_n2 = st.number_input("Injected gas N2", min_value=0.0, max_value=1.0, value=0.01, step=0.001, format="%.4f")
                with lc2:
                    lg_c1 = st.number_input("Injected gas C1", min_value=0.0, max_value=1.0, value=0.94, step=0.001, format="%.4f")
                    lg_c2 = st.number_input("Injected gas C2", min_value=0.0, max_value=1.0, value=0.02, step=0.001, format="%.4f")
                    lg_c3 = st.number_input("Injected gas C3", min_value=0.0, max_value=1.0, value=0.01, step=0.001, format="%.4f")
                with lc3:
                    lg_ic4 = st.number_input("Injected gas iC4", min_value=0.0, max_value=1.0, value=0.0, step=0.001, format="%.4f")
                    lg_nc4 = st.number_input("Injected gas nC4", min_value=0.0, max_value=1.0, value=0.0, step=0.001, format="%.4f")
                    lg_ic5 = st.number_input("Injected gas iC5", min_value=0.0, max_value=1.0, value=0.0, step=0.001, format="%.4f")
                with lc4:
                    lg_nc5 = st.number_input("Injected gas nC5", min_value=0.0, max_value=1.0, value=0.0, step=0.001, format="%.4f")
                    lg_c6 = st.number_input("Injected gas C6", min_value=0.0, max_value=1.0, value=0.0, step=0.001, format="%.4f")
                    lg_c7p = st.number_input("Injected gas C7+", min_value=0.0, max_value=1.0, value=0.0, step=0.001, format="%.4f")
                injected_gas_composition = np.array([lg_h2s, lg_co2, lg_n2, lg_c1, lg_c2, lg_c3, lg_ic4, lg_nc4, lg_ic5, lg_nc5, lg_c6, lg_c7p], dtype=float)
