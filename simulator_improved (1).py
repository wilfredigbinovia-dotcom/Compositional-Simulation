...
class CompositionalSimulator1D:
    ...
    def step_once(self, state: SimulationState, dt_days: float) -> Tuple[SimulationState, Dict[str, float]]:
        ...
        # No post-transport pressure correction: the pressure_update linear solve
        # with real-gas compressibility (cg = 1/P - dZ/dP/Z) is sufficiently
        # accurate for field-scale simulations. Post-transport corrections caused
        # oscillation instability in deployed environments.
...
def display_streamlit_app() -> None:
    ...
    st.caption("Build: nocorr-2026-04-20 · no post-transport pressure correction")
