...
class CompositionalSimulator1D:
    ...
    def run(self, state0: SimulationState, t_end_days: float, dt_days: float) -> Tuple[SimulationState, SimulationHistory]:
        ...
        # Record the true initialized state at t = 0 so summary tables and
        # history-based plots reflect the user-specified starting pressure.
        self._set_cache_state(state)
        ...
        history.cum_gas_bscf.append(0.0)
        history.cum_condensate_mstb.append(0.0)
        history.cum_water_mstb.append(0.0)

        self.record_mass_balance(history, state, 0.0, q_total_0, gas_frac_0, oil_frac_0, water_frac_0, injector_rate_lbmol_day)
