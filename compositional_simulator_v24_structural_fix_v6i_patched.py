...
def generate_chapter4_summary(history: SimulationHistory) -> List[List[object]]:
    ...
    wi_peak, wi_peak_t = max_with_time(history.well_effective_wi)
    ...
    return [
        ...
        ["Effective Well Index (-)", initial_value(history.well_effective_wi), wi_peak, wi_peak_t, final_value(history.well_effective_wi)],
...
def display_streamlit_app() -> None:
    ...
    with result_tabs[0]:
        ...
        st.subheader("Effective Well Index Diagnostics")
        ew1, ew2 = st.columns(2)
        ew1.metric("Initial Effective Well Index", f"{history.well_effective_wi[0]:.5f}")
        ew2.metric("Final Effective Well Index", f"{history.well_effective_wi[-1]:.5f}")
