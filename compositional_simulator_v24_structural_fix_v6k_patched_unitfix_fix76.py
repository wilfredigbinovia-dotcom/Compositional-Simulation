...
def run_example(
    ...
    sim = CompositionalSimulator1D(
        ...
        separator=separator,
        reporting=reporting,
        detailed_mass_balance_diagnostics=detailed_mass_balance_diagnostics,
    )
...
def display_streamlit_app() -> None:
    ...
    with tab_advanced_physics:
        ...
        detailed_mass_balance_diagnostics = st.checkbox("Detailed HC mass-balance diagnostics (slower)", value=False, key="detailed_mass_balance_diagnostics")
        st.caption("Off by default for faster runs. Turn this on only when you want tighter hydrocarbon mass-balance auditing.")
