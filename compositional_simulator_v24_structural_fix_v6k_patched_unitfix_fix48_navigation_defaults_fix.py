...
def display_streamlit_app() -> None:
    ...
    st.sidebar.caption("Click a section name to open that setup page.")
    current_section = st.sidebar.radio(
        "Open section",
        section_options,
        index=0,
        label_visibility="collapsed",
        key="sidebar_section_navigation",
    )
    ...
    if current_section == "Reservoir / Grid":
    ...
    if current_section == "Components / Composition":
    ...
    if current_section == "PVT / Separator":
    ...
    if current_section == "Rock / Rock-Fluid":
    ...
    if current_section == "Initial Conditions":
    ...
    if current_section == "Producer Well":
    ...
    if current_section == "Injector Well":
    ...
    if current_section == "Aquifer / Boundaries":
    ...
    if current_section == "Advanced Physics":
    ...
    if current_section == "Analysis Tools":
    ...
    if current_section != "Results":
        st.info("Use the sidebar to open the Results page after running the simulation.")
        return
